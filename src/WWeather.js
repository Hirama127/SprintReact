        ...
        <>
            <div style={{ width: '100%', height: '100%' }}>
                <table className="tabStyle" style={tabStyle}>
                    ...
                    <tbody>
                        <tr>
                            <th style={tableStyle}>{areaname}</th>
                            <th><img src={imgSrc1} alt={areaname} style={{ width: '100%', height: '100%' }} /></th>
                            <th><img src={imgSrc2} alt={areaname} style={{ width: '100%', height: '100%' }} /></th>
                            <th><img src={imgSrc3} alt={areaname} style={{ width: '100%', height: '100%' }} /></th>
                            <th><img src={imgSrc4} alt={areaname} style={{ width: '100%', height: '100%' }} /></th>
                        ...
                        <tr style={{ textAlign: 'center' }}>
                            ...
                            <th><h2 className="min">{tempMin4}</h2><h2>/</h2><h2 className="max">{tempMax5}</h2></th>
                            <th><h2 className="min">{tempMin5}</h2><h2>/</h2><h2 className="max">{tempMax6}</h2></th>
                        </tr>
                    </tbody>
                </table>
            </div>
